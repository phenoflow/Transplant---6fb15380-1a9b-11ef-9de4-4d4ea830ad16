...
steps:
  read-potential-cases-omop:
    ...
    in:
      inputModule:
        id: inputModule
        source: inputModule1
  renal-transplant---primary:
    run: renal-transplant---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  whole-transplant---primary:
    run: whole-transplant---primary.cwl
    out:
    - output
    in:
      inputModule:
      ...
      potentialCases:
        id: potentialCases
        source: renal-transplant---primary/output
  transplant-organ---primary:
    run: transplant-organ---primary.cwl
    out:
    - output
    in:
      inputModule:
      ...
      potentialCases:
        id: potentialCases
        source: whole-transplant---primary/output
  transplant-marrow---primary:
    run: transplant-marrow---primary.cwl
    out:
    - output
    in:
      inputModule:
      ...
      potentialCases:
        id: potentialCases
        source: transplant-organ---primary/output
  transplant-liver---primary:
    run: transplant-liver---primary.cwl
    out:
    - output
    in:
      inputModule:
      ...
      potentialCases:
        id: potentialCases
        source: transplant-marrow---primary/output
  transplant-cadaver---primary:
    run: transplant-cadaver---primary.cwl
    out:
    - output
    in:
      inputModule:
      ...
      potentialCases:
        id: potentialCases
        source: transplant-liver---primary/output
  transplant---primary:
    run: transplant---primary.cwl
    out:
    - output
    in:
      inputModule:
      ...
      potentialCases:
        id: potentialCases
        source: transplant-cadaver---primary/output
  transplant-donor---primary:
    run: transplant-donor---primary.cwl
    out:
    - output
    in:
      inputModule:
      ...
      potentialCases:
        id: potentialCases
        source: transplant---primary/output
  transplant-kidney---primary:
    run: transplant-kidney---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  transplant-rejection---primary:
    run: transplant-rejection---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  transplant-associated---primary:
    run: transplant-associated---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  acute-transplant---primary:
    run: acute-transplant---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  transplant-grade---primary:
    run: transplant-grade---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  transplant-examination---primary:
    run: transplant-examination---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  orthotopic-transplant---primary:
    run: orthotopic-transplant---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  transplant-complication---primary:
    run: transplant-complication---primary.cwl
    out:
    - output
    in:
      inputModule:
